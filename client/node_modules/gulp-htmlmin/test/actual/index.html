...
<body data-spy="scroll" data-target=".bs-sidebar">
    ...
    <div class="container">
      ...
      <nav class="collapse navbar-collapse bs-navbar-collapse in" role="navigation">
        ...
        <ul class="nav navbar-nav pull-right">
          ...
          <li><a href="https://github.com/assemble/assemble/archive/master.zip" title="Download Assemble"><i class="glyphicon glypicon-large glyphicon-download"></i></a>
          </li>
          <li> <a href="https://github.com/assemble/assemble/">GitHub Repo</a>
          </li>
        </ul>
      </nav>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col col-lg-6">
          ...
          <p> <a class="btn btn-inverse" href="https://github.com/assemble/assemble/archive/master.zip">Download Assemble</a>
          </p>
        </div>
      ...
      <section class="gallery">
        <div class="row">
          ...
          <div class="alert alert-danger">
            <strong>No repos today :-(</strong>wait..! what's that you say?! We're in "dev" mode? Oh, then I was just kidding.
          </div>
  ...
  <div class="banner">
    <div class="container">
      <p> <a href="docs/Home.html">Get Started with Assemble</a>
      </p>
    </div>
  </div>
  ...
  $('.equal .equal-height').equalHeights();
